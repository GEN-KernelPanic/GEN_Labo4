...
public class OrdersWriterTest {
    ...
    public void SetupOneOrder() {
        ...
        @Test
        public void NoOrder() {
            assertEquals("{\"orders\": []}", new OrdersWriter(new Orders()).orders.getContents(new OrdersWriter(new Orders())));
        }

    @Test
    public void OneOrder() {
        String order111 = "{\"id\": 111, \"products\": []}";
        assertEquals("{\"orders\": [" + order111 + "]}", new OrdersWriter(orders).orders.getContents(new OrdersWriter(orders)));
    }
    ...
    public void TwoOrders() {
        ...
        assertEquals("{\"orders\": [" + order111Json + ", " + order222Json + "]}", new OrdersWriter(orders).orders.getContents(new OrdersWriter(orders)));
    }
    ...
    public void OneOrderWithOneProduct() {
        ...
        assertEquals("{\"orders\": [" + order111Json + "]}", new OrdersWriter(orders).orders.getContents(new OrdersWriter(orders)));
    }
